...
build: bridge/incognito_proxy/incognito_proxy.go bridge/vault/vault.go bridge/pause/pause.go bridge/erc20/fail/fail.go
...
bridge/erc20/fail/fail.go: erc20/fail/fail.sol
