...
contract ZRXTrade is TradeUtils
{
    ...
    function trade(IERC20 srcToken, uint amount, IERC20 destToken, bytes memory callDataHex, address _forwarder) public payable isIncognitoSmartContract returns (address, uint) {
